...
-verbose #混淆时是否记录日志
#-repackageclasses com.kserjhfnkedjfv.camerax #增加反编译难度把混淆的很多个文件全部放在同一个目录下
...
#-keepnames class Tools



 #-keep @AppKeep class * {*;}
 #-keep class * {@AppKeep <fields>;}
 #-keepclassmembers class * {@AppKeep <methods>;}
